...
<div className="flex flex-col w-full md:w-2/5 border-t md:border-t-0 md:border-l border-gray-200 md:pl-4 pt-4 md:pt-0">
  ...
  {/* Scrollable lecture list if more than 5 lectures */}
  <div
    className={`flex-1 overflow-y-auto pr-2 ${
      courseDetails?.lectures.length > 5 ? "max-h-80" : ""
    }`}
    style={{
      scrollbarWidth: "thin",
      scrollbarColor: "rgba(100, 100, 100, 0.6) rgba(200, 200, 200, 0.3)",
    }}
  >
